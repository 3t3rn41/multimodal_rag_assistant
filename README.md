...
| 负责人 | 角色 | 主要交付物 |
| --- | --- | --- |
| 孙凡钧 | 全栈工程师 | 前端、FastAPI 后端、异步任务、MySQL 脚本、Docker Compose、全链路联调 |
| 刘喆 | 多模态数据工程师 | 文档/媒体解析、对齐融合、切片与元数据规范、Embedding 入库、质量样例集 |
| 郑嘉辉 | AI 与 RAG 算法工程师 | 混合检索、Rerank、Prompt 模板、大模型适配、引用输出、评估脚本与报告 |
